...
- **Cloud** = Alquilas recursos y el proveedor los administra.

## ¿Qué es On-Premise?

**On-Premise** significa que toda la infraestructura tecnológica (servidores, almacenamiento, redes y software) está instalada físicamente dentro de la empresa.

La empresa compra todo el hardware y es responsable de instalarlo, configurarlo, mantenerlo y repararlo.

**Por ejemplo:**

Una empresa compra un servidor Dell, lo instala en un cuarto especial, conecta la electricidad, instala Windows Server o Linux y ejecuta allí su aplicación.

Todo pertenece a la empresa.
...
**Cloud Computing** es el modelo donde los recursos de computación (servidores, almacenamiento, bases de datos, redes) son propiedad de un proveedor externo (como Microsoft Azure, AWS o Google Cloud) y se alquilan a través de internet bajo demanda.
